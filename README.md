...
```html
<script type="module">
import { classify, initialize } from 'https://cdn.example.com/@postalsys/bounce-classifier/src/index.js';
...
```javascript
import { extractRetryTiming, identifyBlocklist, getAction, extractSmtpCodes } from '@postalsys/bounce-classifier';
